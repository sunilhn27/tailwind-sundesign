...
function RecentWork() {
    return (
        <section className='my-44 text-white w-full h-[80rem] xl:h-[40rem] bg-my_bg_image  '>
            <div className='mx-32 md:mx-16 pt-5'>
                <div className='mx-auto flex flex-col w-[34rem] h-[6rem]'>
                    <h1 className='text-[3rem] md:text-[4rem]'>My recent <span className='text-[#00ADB5]'>works</span>  </h1>
