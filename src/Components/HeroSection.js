    ...
    return (
        <section className='text-white  min-w-min h-[44rem]  mx-12'>
            <div className='flex flex-col-reverse md:flex-row justify-evenly pt-12'>
                ...
                <div className='flex flex-col mt-12 2xl:ml-12'>

                    <div className='text-3xl md:text-[6rem] w-[20rem] md:w-[38rem] md:h-[14rem] md:leading-[6.5rem] 2xl:w-[40rem] '>
                ...
                <div className='relative mb-12 md:mb-0'>
                    ...
                    <Image alt="pic" src={Hero} className='absolute top-44 left-5 md:top-52  w-[16rem] md:w-[22rem] md:h-[22rem]' />
                </div>
            </div>
        </section>
    )
